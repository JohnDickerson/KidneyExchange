...
public class VariationCPLEXSolver extends CPLEXSolver {
	...
	public VariationCPLEXSolver(Pool pool, List<Cycle> cycles, CycleMembership membership) {
		// Use the normal solver without any failure probabilities
		this(pool, cycles, membership, false);
	}
	
	public VariationCPLEXSolver(Pool pool, List<Cycle> cycles, CycleMembership membership, boolean usingFailureProbabilities) {
		super(pool);
		this.cycles = cycles;
